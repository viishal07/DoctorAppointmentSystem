...
public interface IAppointmentService
{
    ...
    Task ApproveAppointmentAsync(Guid appointmentId, UpdateAppointmentStatusDto dto);
    Task RejectAppointmentAsync(Guid appointmentId, UpdateAppointmentStatusDto dto);
